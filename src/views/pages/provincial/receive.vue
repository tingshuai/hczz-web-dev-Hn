<template>
  <el-card shadow="always" class="directive-ct directive-check-ct" style="background: #f0f0f0;border:none">  
    ...
    <Form inline :label-width="75" class="search-ct">
      ...
      <FormItem label="发起时间：">
        <DatePicker type="daterange" :start-date="new Date(new Date()-30*24*3600*1000)" clearable placement="bottom-end" placeholder="请选择发起时间" style="width: 180px" @on-change="handleDate"></DatePicker>
      </FormItem>
    ...
    <div class="table-ct myTable" :style="{height:height}">
      <el-table :data='list' :stripe="true" height="100%" :row-class-name="tableRowClassName">
        ...
        <el-table-column label="发起时间" align="center" :show-overflow-tooltip="true">
          <template slot-scope="scope">
